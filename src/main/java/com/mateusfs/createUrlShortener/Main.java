package com.mateusfs.createUrlShortener;
...
public class Main implements RequestHandler<Map<String, Object>, Map<String, String>> {
    ...
    public Map<String, String> handleRequest(Map<String, Object> input, Context context) {
        ...
        try {
            ...
            PutObjectRequest request = PutObjectRequest.builder().bucket("mfs-shortener-storage").key(shortUrlCode + ".json").build();

            s3Client.putObject(request, RequestBody.fromString(urlDataJson));
        } catch(Exception exception) {
            throw new RuntimeException("Error saving URL data to S3: " + exception.getMessage());
        }
